...
package nie.translator.mohzianuvaad.tools.gui.peers.array;

import android.content.Context;
import androidx.annotation.NonNull;
import java.util.Collection;
import nie.translator.mohzianuvaad.R;
import nie.translator.mohzianuvaad.tools.gui.WeightArray;
import nie.translator.mohzianuvaad.tools.gui.WeightElement;
import nie.translator.mohzianuvaad.tools.gui.peers.GuiPeer;
import nie.translator.mohzianuvaad.tools.gui.peers.Header;
