...
public class Message implements Parcelable, Cloneable {
     ...
     */
    public ArrayDeque<nie.translator.mohzianuvaad.bluetooth.BluetoothMessage> splitInBluetoothMessages(nie.translator.mohzianuvaad.bluetooth.BluetoothMessage.SequenceNumber id) {
        int subDataLength = nie.translator.mohzianuvaad.bluetooth.BluetoothConnection.SUB_MESSAGES_LENGTH - nie.translator.mohzianuvaad.bluetooth.BluetoothMessage.TOTAL_LENGTH;
        ...
        nie.translator.mohzianuvaad.bluetooth.BluetoothMessage.SequenceNumber sequenceNumber = new nie.translator.mohzianuvaad.bluetooth.BluetoothMessage.SequenceNumber(context, nie.translator.mohzianuvaad.bluetooth.BluetoothMessage.SEQUENCE_NUMBER_LENGTH);
        ArrayDeque<nie.translator.mohzianuvaad.bluetooth.BluetoothMessage> bluetoothMessages = new ArrayDeque<>();
        while (subDataArray.peekFirst() != null) {
            byte[] subData = subDataArray.pollFirst();
            int type;
            if (subDataArray.peekFirst() == null) {
                type = nie.translator.mohzianuvaad.bluetooth.BluetoothMessage.FINAL;
            } else {
                type = nie.translator.mohzianuvaad.bluetooth.BluetoothMessage.NON_FINAL;
            }
            bluetoothMessages.addLast(new nie.translator.mohzianuvaad.bluetooth.BluetoothMessage(context, id.clone(), sequenceNumber.clone(), type, subData));
