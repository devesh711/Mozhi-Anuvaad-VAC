package nie.translator.mohzianuvaad.voice_translation._text_translation;
...
public class TranslationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        toolbarContainer = view.findViewById(R.id.toolbamohzianuvaadContainer);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = activity.findViewById(R.id.toolbamohzianuvaad);
