...
package nie.translator.mohzianuvaad.settings;
...
import nie.translator.mohzianuvaad.tools.GalleryImageSelector;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        userImagePreference.setLifecycleListener(new UserImagePreference.LifecycleListener() {
            ...
            public void onBindViewHolder() {
                userImageContainer = new GalleryImageSelector(userImagePreference.getImage(), activity, SettingsFragment.this, R.drawable.user_icon, "com.gallery.mohzianuvaad.2.0.provider");
            }
        });
